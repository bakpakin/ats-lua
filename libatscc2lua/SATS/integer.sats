...
fun lnot_int0 : (int) -<fun> int = "mac#%"
fun lor_int0_int0 : (int, int) -<fun> int = "mac#%"
fun lxor_int0_int0 : (int, int) -<fun> int = "mac#%"
fun land_int0_int0 : (int, int) -<fun> int = "mac#%"
...
(* ****** ****** *)
//
fun succ_uint0 : uint -<fun> uint = "mac#%"
fun pred_uint0 : uint -<fun> uint = "mac#%"
//
...
(* ****** ****** *)
//
fun lnot_uint0 : (uint) -<fun> uint = "mac#%"
fun lor_uint0_uint0 : (uint, uint) -<fun> uint = "mac#%"
fun lxor_uint0_uint0 : (uint, uint) -<fun> uint = "mac#%"
fun land_uint0_uint0 : (uint, uint) -<fun> uint = "mac#%"
//
(* ****** ****** *)
//
